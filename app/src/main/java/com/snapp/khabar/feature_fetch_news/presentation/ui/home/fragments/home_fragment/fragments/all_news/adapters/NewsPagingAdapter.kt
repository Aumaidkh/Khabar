...
class NewsPagingAdapter(
...
) : PagingDataAdapter<ArticleModel,NewsPagingAdapter.ArticleModelViewHolder>(DIFF_UTIL_CALLBACK){
    ...
    override fun onBindViewHolder(holder: ArticleModelViewHolder, position: Int) {
        val currentArticleModel = getItem(position)
    ...
    companion object {
        val DIFF_UTIL_CALLBACK = object : DiffUtil.ItemCallback<ArticleModel>(){
